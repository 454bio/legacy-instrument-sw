...
contrast_info = (-100,100,0,5)
saturation_info = (-100,100,0,5)
...
class ZionCamera(PiCamera):
	...
	def interactive_preview(self, baseFilename=None, init_file_idx=0, cropping=(0,0,1,1), window=None):
		...
		keyboard.add_hotkey('b', self.increase_exposure)
		keyboard.add_hotkey('g', self.decrease_exposure)
		...
		keyboard.add_hotkey('F1', self.set_exposure_mode, args=(exposure_mode_info[0],))
		keyboard.add_hotkey('F2', self.set_exposure_mode, args=(exposure_mode_info[1],))
		keyboard.add_hotkey('F3', self.set_exposure_mode, args=(exposure_mode_info[2],))
		keyboard.add_hotkey('F4', self.set_exposure_mode, args=(exposure_mode_info[3],))
		keyboard.add_hotkey('F5', self.set_exposure_mode, args=(exposure_mode_info[4],))
		keyboard.add_hotkey('F6', self.set_exposure_mode, args=(exposure_mode_info[5],))
		keyboard.add_hotkey('F7', self.set_exposure_mode, args=(exposure_mode_info[6],))
		keyboard.add_hotkey('F8', self.set_exposure_mode, args=(exposure_mode_info[7],))
		keyboard.add_hotkey('F9', self.set_exposure_mode, args=(exposure_mode_info[8],))
		keyboard.add_hotkey('F10', self.set_exposure_mode, args=(exposure_mode_info[9],))
		keyboard.add_hotkey('F11', self.set_exposure_mode, args=(exposure_mode_info[10],))
		keyboard.add_hotkey('F12', self.set_exposure_mode, args=(exposure_mode_info[11],))
