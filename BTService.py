...
class Application(dbus.service.Object):
    def __init__(self):
        ...
        self.services = []
        self.next_index = 0
        super(Application, self).__init__(self.bus, self.path)
...
class Service(dbus.service.Object):
    ...
    def __init__(self, index, uuid, primary):
        ...
        self.next_index = 0
        super(Service, self).__init__(self.bus, self.path)
...
class Characteristic(dbus.service.Object):
    ...
    def __init__(self, uuid, flags, service):
        ...
        self.descriptors = []
        self.next_index = 0
        super(Characteristic, self).__init__(self.bus, self.path)
...
class Descriptor(dbus.service.Object):
    def __init__(self, uuid, flags, characteristic):
        ...
        super(Descriptor, self).__init__(self.bus, self.path)
...
class CharacteristicUserDescriptionDescriptor(Descriptor):
    ...
    def __init__(self, bus, index, characteristic):
        ...
        super(CharacteristicUserDescriptionDescriptor, self).__init__(
                bus, index,
                self.CUD_UUID,
                ['read', 'write'],
                characteristic)
