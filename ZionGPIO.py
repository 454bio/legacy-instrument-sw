...
LED_GPIOS = {
    ...
    ZionLEDColor.WEST: [18,19], #LED_ENs 2,3 gpio hw pins 12,35
    ZionLEDColor.NORTH: [20,21], #LED_ENs 4,5 gpio hw pins 38,40
    ZionLEDColor.SOUTH: [16,17], #LED_ENs 0,1 gpio hw pins 36,11
    # TODO: update color names here and/or assign multiple GPIOs to colors
    ZionLEDColor.EAST: [22,23], #LED_ENs 6,7 gpio hw pins 15,16
    ZionLEDColor.COLOR4: [],
    ZionLEDColor.COLOR5: [],
    ZionLEDColor.COLOR6: [],
    ZionLEDColor.COLOR7: [],
